...
int main(void) {
    ...
    Rectangle wall = { 700, GetScreenHeight()/2.0f - 50, 200, 125 };
    ...
    Vector2 hitboxVelocity = player.characterVelocity;
    
    Rectangle hitbox = {hitboxPos.x, hitboxPos.y, frameWidth/2.5, character.height/2.3};
    ...
    while(!WindowShouldClose()) { // Enquanto nao apertar ESC
        ...
        collision = CheckCollisionRecs(hitbox, wall);
        ...
        if(IsCharacterOnGround(character, player.characterPos, groundYPos)) { // Se o personagem estiver no chao
            ...
            if(IsKeyDown(KEY_SPACE)) {
                ...
                hitboxVelocity.y = player.characterVelocity.y; 
            }
            ...
            if(IsKeyDown(KEY_D) || IsKeyDown(KEY_RIGHT)) {
                ...
                hitboxVelocity.x = player.characterVelocity.x;
        ...
        player.characterMoving = hitboxVelocity.x != 0.0f || hitboxVelocity.y != 0.0f;
        ...
        hitboxPos = Vector2Add(hitboxPos, hitboxVelocity);
        ...
        if(player.characterIsOnGround) {
            ...
            hitboxPos.y = player.characterPos.y;
        ...
        if(frameDelayCounter > frameDelay) {
            ...
            hitbox.x = player.characterPos.x + 40;
            hitbox.y = player.characterPos.y + 45;
